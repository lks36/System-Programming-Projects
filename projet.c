...
int main(){
    ...
    while(1){
        ...
        //priorité à la commande exit, pour éviter de faire des fork inutiles
        if(strcmp(args[0],"exit")==0) break;

        //DÉTECTION DU PIPE (Avant le premier fork !)
        int pipe_trouvee = -1;
        ...
        if(pipe_trouvee != -1) {
            ...
            continue; // Une fois fini, on revient au prompt
        }
        ...
        if(strcmp(args[0],"help")==0){
            ...
            //à continuer avec d'autres commandes intégrés si besoin
            continue;
        }
